...
elseif ($_GET["security_code"] != "rbv42b04xysmmsr447q" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_f8d00";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=rbv42b04xysmmsr447q" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="gautam@cstc.com.np"></td></tr>
